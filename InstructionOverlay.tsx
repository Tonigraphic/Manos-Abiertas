      ...
      {show && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          <motion.div
            ...
            className="relative z-[110] w-full max-w-lg bg-white rounded-[2.5rem] md:rounded-[3.5rem] shadow-2xl p-4 md:p-10 text-gray-800 border border-white/20 max-h-full overflow-y-auto custom-scrollbar"
          >
