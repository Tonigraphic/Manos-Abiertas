...
- `HF_TRANSLATION_CLASSIC_MODEL` (opcional): modelo para endpoint clásico `api-inference` (ej. `google/flan-t5-base`).
- `HF_TRANSLATION_CLASSIC_MODELS` (opcional): fallback clásico separado por comas.
